...
//   accent1 >= 3.0 against the page   (#14151a) - large Bebas headings
...
export const TEAMS: Team[] = [
  ...
  { slug: 'ne',  name: 'New England Patriots', shortName: 'Patriots',   conference: 'AFC', division: 'East',  brand1: '#002244', brand2: '#C60C30', accent1: '#E8394F', accent2: '#B0B7BC', logoUrl: '/logos/ne.svg' },
  ...
  // ---- AFC North ----
  { slug: 'bal', name: 'Baltimore Ravens',     shortName: 'Ravens',     conference: 'AFC', division: 'North', brand1: '#241773', brand2: '#9E7C0C', accent1: '#7B5CD6', accent2: '#D4A62A', logoUrl: '/logos/bal.svg' },
  ...
  // ---- AFC South ----
  { slug: 'hou', name: 'Houston Texans',       shortName: 'Texans',     conference: 'AFC', division: 'South', brand1: '#03202F', brand2: '#A71930', accent1: '#E03A52', accent2: '#5A9BC4', logoUrl: '/logos/hou.svg' },
  ...
  { slug: 'kc',  name: 'Kansas City Chiefs',   shortName: 'Chiefs',     conference: 'AFC', division: 'West',  brand1: '#E31837', brand2: '#FFB81C', accent1: '#E31837', accent2: '#FFB81C', logoUrl: '/logos/kc.svg' },
  ...
  { slug: 'nyg', name: 'New York Giants',      shortName: 'Giants',     conference: 'NFC', division: 'East',  brand1: '#0B2265', brand2: '#A71930', accent1: '#4C79E0', accent2: '#E4566A', logoUrl: '/logos/nyg.svg' },
  ...
  { slug: 'min', name: 'Minnesota Vikings',    shortName: 'Vikings',    conference: 'NFC', division: 'North', brand1: '#4F2683', brand2: '#FFC62F', accent1: '#8B5CD6', accent2: '#FFC62F', logoUrl: '/logos/min.svg' },

  // ---- NFC South ----
  { slug: 'atl', name: 'Atlanta Falcons',      shortName: 'Falcons',    conference: 'NFC', division: 'South', brand1: '#A71930', brand2: '#101820', accent1: '#E03A52', accent2: '#A5ACAF', logoUrl: '/logos/atl.svg' },
  ...
  { slug: 'tb',  name: 'Tampa Bay Buccaneers', shortName: 'Buccaneers', conference: 'NFC', division: 'South', brand1: '#D50A0A', brand2: '#FF7900', accent1: '#E8323A', accent2: '#FF7900', logoUrl: '/logos/tb.svg' },

  // ---- NFC West ----
  { slug: 'ari', name: 'Arizona Cardinals',    shortName: 'Cardinals',  conference: 'NFC', division: 'West',  brand1: '#97233F', brand2: '#FFB612', accent1: '#D6425F', accent2: '#FFB612', logoUrl: '/logos/ari.svg' },
  ...
  { slug: 'sf',  name: 'San Francisco 49ers',  shortName: '49ers',      conference: 'NFC', division: 'West',  brand1: '#AA0000', brand2: '#B3995D', accent1: '#D62828', accent2: '#C9AE72', logoUrl: '/logos/sf.svg' },
